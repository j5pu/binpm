...
*{manname}* --init
include::/usr/local/include/man/SYNOPSIS-ARGUMENTS_Information.adoc[]
...
[verse]
_$_ eval "$(*{manname}* --base)"
_$_ eval "$(*{manname}* --init)"
_$_ eval "$(*{manname}*)"
_$_ eval "$(*{manname}* --init -P)"
_$_ eval "$(*{manname}* --bins)"
_$_ eval "$(*{manname}* --bins .)"
_$_ eval "$(*{manname}* --bins "$0")"
_$_ PATH="$(*{manname}* . "${PATH}")"
_$_ eval "$(*{manname}* . "${PATH}" --export)"
_$_ PATH="$(*{manname}* --append . "${PATH}")"
_$_ PATH="$(*{manname}* --remove . "${HOME}")"
